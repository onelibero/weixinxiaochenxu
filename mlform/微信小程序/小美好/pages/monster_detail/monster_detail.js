...
Page({
    ...
    onLoad: function (options) {
       ...
       for(var l in item.comments){
        item.comments[l].create_time=util.formatTime(new Date(item.comments[l].create_time))
       }
        this.setData({
    ...
    publish(){
       ...
       let item={content:that.data.reply_content,create_time:1654421898000,review:review_,review_to:review_to_,}
